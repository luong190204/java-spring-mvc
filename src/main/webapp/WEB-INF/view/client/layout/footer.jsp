                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">@dinhluongIT</p>
                            </a>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mx-auto">
                                ...
                                <button type="submit"
                                    ...
                                    style="top: 0; right: 0;">Liên hệ ngay</button>
                            </div>
                        </div>
                        <div class="col-lg-3">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Địa chỉ: 245 Hùng Vương, Hoàng Mai, Nghệ An</p>
                            <p>Email: dinhluong19002004@gmail.com</p>
                            <p>Số điện thoại: +84 977 417 022</p>
